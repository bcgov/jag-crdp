...
public class TransformerServiceTests {
    ...
    //
    //        when(controller.validateXml(Mockito.any(String.class),
    ...
    // Mockito.any(InputStream.class)))
    //                .thenReturn(true);
    //        Assertions.assertThrows(ORDSException.class, () ->
    // controller.processAuditSvc(fileName));
    //    }
    //
    //    @Test
    ...
    //        ResponseEntity<Map<String, String>> responseEntity = new ResponseEntity<>(m,
    // HttpStatus.OK);
    //        m.put("status", "N");
    //
    //        // Set up to mock ords response
