...
public class SftpServiceImplListFileTest {
    ...
    @Mock private ChannelSftp.LsEntry lsEntry1Mock;

    @Mock private ChannelSftp.LsEntry lsEntry2Mock;

    @Mock private ChannelSftp.LsEntry lsEntry3Mock;

    @Mock private SftpProperties sftpPropertiesMock;
    ...
    @Test
    @DisplayName(
            "Success - Test with valid remote file name windows like list and remote location set")
